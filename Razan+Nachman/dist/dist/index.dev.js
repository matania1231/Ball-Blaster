  ...
  GameController.prototype.checkCollision = function () {
    ...
    this.model.bullets.forEach(function (bullet) {
      ...
      _this.model.balls.forEach(function (ball) {
        ...
        var collision = bulletRect.left < ballRect.right && bulletRect.right > ballRect.left && bulletRect.top < ballRect.bottom && bulletRect.bottom > ballRect.top;
